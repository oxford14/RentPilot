...
import { Briefcase, PlusCircle, CalendarIcon, TrendingUp, PiggyBank, HandCoins, ArrowDownRight, Wallet } from 'lucide-react';
import { format, previousFriday } from 'date-fns';
import { cn } from '@/lib/utils';
import type { WeeklyIncome } from '@/lib/types';

export default function TrackingPage() {
  const { businesses, weeklyIncomes, addBusiness, addWeeklyIncome } = useAppContext();
