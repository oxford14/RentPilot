...
export default function ViewContractPage() {
    ...
    // The route is /view/[contractId], but we pass the tenant's ID in the URL.
    // So, params.contractId will actually hold the tenantId.
    ...
    useEffect(() => {
        ...
        loadContract();
    }, [tenantId, tenants, signedContracts, clients, toast]);
