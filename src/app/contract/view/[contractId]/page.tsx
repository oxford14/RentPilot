...
export default function ContractViewerPage() {
    ...
    // Use `params.contractId` as the tenantId
    ...
    useEffect(() => {
        ...
        if (tenants.length === 0 && signedContracts.length === 0 && !isAuthLoading) {
            setIsLoading(false);
            return;
        }
             ...
             <Card className="shadow-xl">
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        {contractSource?.type === 'signed' ? (
                            <Button onClick={handleDownloadPdf} disabled={isExporting}>
                             ...
                             <Button asChild>
                                <a href={contractSource.data} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center">
                ...
                <CardContent>
                    {contractSource?.type === 'signed' ? (
                        ...
                        <div className="h-[calc(100vh-20rem)] border rounded-md bg-muted/30 flex items-center justify-center p-4 text-center">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mb-4">The uploaded PDF cannot be displayed here. Please open it in a new tab to view.</p>
                             <Button asChild>
                                <a href={contractSource.data} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center">
                                    <FileDown className="mr-2 h-4 w-4" />
                                    Open PDF in New Tab
